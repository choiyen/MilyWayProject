...
public class UserDTO //관리자 아이디를 관리하는 DTO
{
    ...
    @ApiModelProperty(value = "관리자를 제어하기 위한 테이블", example = "cs1459")
    ...
    @ApiModelProperty(value = "관리자를 제어하기 위한 비밀번호", example = "asdZXC@123")
    private String Password; //비밀번호

    @NotNull(message = "Name cannot be null")
    @NotBlank(message = "Name cannot be empty")
    @Email(message = "email is Email Type(example : kons@sdffdf.com")
    @ApiModelProperty(value = "관리자를 찾기 위한 이메일", example = "asdZXC147@naver.com")
