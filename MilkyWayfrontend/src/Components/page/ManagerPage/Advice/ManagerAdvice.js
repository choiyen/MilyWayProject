...
export const ManagerAdvice = () => {
    ...
    const [type, setType] = useState("주거청소");
    const [greeting, setgreeting] = useState("");
    const [title, setTitle] = useState("");
    const [cleanspot, setcleanspot] = useState(["부엌"]);
    ...
    return (_jsxs(_Fragment, { children: [loading && _jsx(LoadingModal, { message: "\uC5C5\uB85C\uB4DC \uC911\uC785\uB2C8\uB2E4..." }), _jsx("div", { style: { width: "100%" }, children: _jsxs(MainBox, { children: [_jsx(Fontname, { children: "\uD6C4\uAE30 \uAD00\uB9AC" }), _jsxs(Wapper, { children: [_jsxs("div", { style: { width: "100%", gap: "50px" }, children: [_jsx(InputTextBox, { name: "제목", place: "후기 제목을 입력해주세요.", Value: title, setValue2: setTitle }), _jsx(SelectBox, { name: "청소 유형", append: cleanType, value: type, setValue: setType }), _jsx(FileTage, { name: "대표 이미지", setValue2: setTitleimg }), _jsx(TextAreaBox, { name: "도입 인사", Value: greeting, setValue2: setgreeting })] }), [...Array(count)].map((_, i) => (_jsxs(CardContainer, { ref: i === count - 1 ? lastItemRef : null, children: [_jsxs(Fontname, { style: {
                                                fontWeight: "bold",
                                                textAlign: "center",
                                                ...
                                                margin: "0px",
                                            }, children: ["\uAC8C\uC2DC\uD310 \uAD6C\uC5ED ", i + 1] }), _jsxs(DeskContainer, { children: [_jsx(SelectBox, { name: "청소 위치", append: RoomType, value: cleanspot[i], updateCleanspot: updateCleanspot, Cleancount: i }), _jsx(FileTage, { name: "청소 이전", Value: beforefile, setBeforeValue: setbeforefile, index: i, type: "before" }), _jsx(FileTage, { name: "청소 이후", Value: afferfile, setAfferValue: setAfferfile, index: i, type: "after" }), _jsx(Textareas, { placeholder: "청소할 때 힘들었던 점이나 후기 글을 작성해주세요.", value: Advice[i] || "", onChange: (e) => {
                                                        const newAdvice = [...Advice];
                                                        newAdvice[i] = e.target.value;
                                                        SetAdvice(newAdvice);
                                                    } })] })] }, i))), _jsx(ImgTag, { src: plus, style: {
                                        width: isMobile ? "40px" : "60px",
                                        height: isMobile ? "40px" : "60px",
                                        marginTop: "20px",
                                        cursor: "pointer",
                                    }, onClick: cleanCount })] }), _jsx(LastButton, { onClick: handleOnclick, children: "\uC5C5\uB85C\uB4DC" })] }) })] }));
};
