...
export const BoardPOST = async (boardId: string) => {
  return await GET({
...
export const CommentPOST = async (boardId: string) => {
  return await GET({
...
export const CommentInsert = async (input: CommentValueType) => {
  return await POST({
...
export const DateUpdate = (isoString: string) => {
